...
# The problem is that the to_s method is in the File superclass, therefore the FORMAT constant is being pulled from there, but there is no FORMAT constant within File. 